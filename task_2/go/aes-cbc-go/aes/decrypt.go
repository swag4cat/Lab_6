...
// Расшифровка одного блока с использованием раундовых ключей
func DecryptBlock(input Block, roundKeys []Block) Block {
	state := XorBlocks(input, roundKeys[10]) // AddRoundKey с последним ключом
